...
namespace GrupoEmporium.Reportes
{
	/// <summary>
	/// Formulario para seleccionar el reporte de Saint que se va a generar.
	/// </summary>
	public class FormReportes : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            "Experiencia",
            "Cartas Morosos 2 y 3 meses",
            "Cartas Morosos 6 o mas  meses",
            "Cartas Morosos Por rango de meses",
            "Cartas Morosos Por rango de meses con Encuesta",
            "Cartas Ultimo Aviso",
            "Carta Legal",
		...
		private void BotonCrearReporte_Click(object sender, System.EventArgs e)
		{
			...
			switch(ComboReporte.SelectedIndex)
			{
				...
				case 0:  // Experiencia Profit
					...
					break;
				case 1: // Reporte Morosos 2 y 3 meses
					ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
					...
					break;
				case 2: // Reporte Morosos 6 meses
					ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
					...
					break;
				case 3: // Reporte Morosos Por Meses
					...
					break;
				case 4: // Reporte Morosos Por Meses con encuesta
					if(textMesHasta.Text!="" && textMesDesde.Text!="")
					{
						ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
					...
					break;
				case 5: // Reporte Morosos Por Meses + Ultimo Aviso
					if(textMesHasta.Text!="" && textMesDesde.Text!="")
					{
						ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
					...
					break;
				case 6: // Reporte Morosos + Carta Legal
					if(textMesHasta.Text!="" && textMesDesde.Text!="")
					{
						ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
					...
					break;
				case 7: // Reporte Listado Todos Los Morosos
						ObjProfit = new Profit.Reportes.Profit(Fecha.Value);
		...
		private void BotonExportar_Click(object sender, System.EventArgs e)
		{
			...
			switch(ComboReporte.SelectedIndex)
			{
                ...
                case 6:
                case 7:
                    Mensaje.Informar("Reporte Deshabilitado, contacte al administrador del sistema", this);
                    break;
					SFD.ShowDialog(this);
					if(SFD.FileNames[0].Trim()!="")
					{
